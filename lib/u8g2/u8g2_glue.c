...
uint8_t u8g2_gpio_and_delay_stm32(u8x8_t* u8x8, uint8_t msg, uint8_t arg_int, void* arg_ptr) {
    ...
    case U8X8_MSG_GPIO_AND_DELAY_INIT:
        ...
        furi_hal_gpio_write(&gpio_display_rst_n, DISPLAY_RST_INVERT ? false : true);
...
uint8_t u8x8_hw_spi_stm32(u8x8_t* u8x8, uint8_t msg, uint8_t arg_int, void* arg_ptr) {
    ...
    case U8X8_MSG_BYTE_SEND:
        return furi_hal_spi_bus_tx(
            &furi_hal_spi_bus_handle_display, (uint8_t*)arg_ptr, arg_int, 10000);
    ...
    case U8X8_MSG_BYTE_START_TRANSFER:
        ...
        furi_hal_gpio_write(&gpio_display_cs, DISPLAY_CS_INVERT ? true : false);
        break;
...
void u8g2_Setup_st756x_flipper(
    ...
    if(byte_cb == u8x8_hw_spi_stm32) {
        ...
        u8g2_SetupDisplay(
            u8g2, u8x8_d_ssd1309_128x64_noname0, u8x8_cad_001, byte_cb, gpio_and_delay_cb);
#else
        u8g2_SetupDisplay(
            u8g2, u8x8_d_ssd1309_128x64_noname2, u8x8_cad_001, byte_cb, gpio_and_delay_cb);
#endif
#elif DISPLAY_CONTROLLER_SSD1306
