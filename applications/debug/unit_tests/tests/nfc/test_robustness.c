...
MU_TEST(nfc_timeout_constants_defined) {
    ...
    mu_assert(PN532_TIMEOUT_CMD_MS == 250, "PN532_TIMEOUT_CMD_MS != 250");
    mu_assert(PN532_TIMEOUT_POLL_MS == 300, "PN532_TIMEOUT_POLL_MS != 300");
    mu_assert(PN532_TIMEOUT_EXCHANGE_MS == 1000, "PN532_TIMEOUT_EXCHANGE_MS != 1000");
    mu_assert(PN532_TIMEOUT_EXCHANGE_4K_MS == 1500, "PN532_TIMEOUT_EXCHANGE_4K_MS != 1500");
    mu_assert(PN532_TIMEOUT_PRESENCE_MS == 100, "PN532_TIMEOUT_PRESENCE_MS != 100");
}
