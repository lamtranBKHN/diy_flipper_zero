...
static void nfc_scene_more_info_on_enter_iso14443_4b(NfcApp* instance) {
    const NfcDevice* device = instance->nfc_device;
    const Iso14443_4bData* data = nfc_device_get_data(device, NfcProtocolIso14443_4b);

    FuriString* temp_str = furi_string_alloc();
    nfc_render_iso14443_4b_dump(data, temp_str);
...
const NfcProtocolSupportBase nfc_protocol_support_iso14443_4b = {
    ...
    .scene_more_info =
        {
            .on_enter = nfc_scene_more_info_on_enter_iso14443_4b,
            .on_event = nfc_protocol_support_common_on_event_empty,
        },
    .scene_read =
        {
